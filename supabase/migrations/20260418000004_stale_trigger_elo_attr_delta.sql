-- Phase 5: extend mark_elo_metrics_stale() to invalidate eloAttrDelta:* and
-- eloAttrDeltaHist:* rows on variant rating changes. Ensures the attribution
-- bar chart + histogram recompute after arena-match-driven parent ELO drift.
