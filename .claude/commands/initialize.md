...
Read these 3 core docs (always, regardless of branch type — ~4.5k tokens, 2.2% of context):

1. `docs/docs_overall/getting_started.md`
2. `docs/docs_overall/architecture.md`
3. `docs/docs_overall/project_workflow.md`

<!-- TODO: Phase 3 will add doc-cost estimator gate here via bash .claude/lib/estimate-docs.sh -->
