 ...
 * - no-subdefault-expect-timeout: Warn on hardcoded assertion timeouts <= local expect default (shrinks CI/prod budget)
...
module.exports = {
  rules: {
    ...
    'no-subdefault-expect-timeout': require('./no-subdefault-expect-timeout'),
