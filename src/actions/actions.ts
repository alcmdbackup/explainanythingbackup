...
const _getExplanationByIdAction = async function(params: { id: number }) {
    ...
    if (process.env.E2E_TEST_MODE === 'true' && params.id >= 90000) {
        ...
        const mockTitles: Record<number, string> = {
            90001: 'Understanding Quantum Entanglement',  // defaultMockExplanation
            90002: 'Brief Explanation',                   // shortMockExplanation
        };
...
This fascinating phenomenon challenges our classical understanding of physics and opens doors to revolutionary technologies.`,
            90002: 'This is a short explanation for testing purposes.',
        };
        return {
            id: params.id,
