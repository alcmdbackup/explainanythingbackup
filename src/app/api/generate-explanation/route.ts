...
import { explanationBaseType, explanationBaseSchema, MatchMode, UserInputType } from '@/lib/schemas/schemas';
...
import { withLoggingAndTracing } from '@/lib/functionLogger';
...
const generateExplanationLogic = withLoggingAndTracing(
