...
const baseProps = {
  ...
  run: baseRun,
  diffMetrics: { variantsAdded: 2, matchesPlayed: 5, newVariantIds: [], eloChanges: {}, critiquesAdded: 0, diversityScoreAfter: 0, metaFeedbackPopulated: false } as DiffMetrics,
  inputVariant: null,
  variantDiffs: [],
  eloHistory: {},
};
