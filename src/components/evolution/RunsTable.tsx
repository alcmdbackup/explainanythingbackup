...
import { TableSkeleton } from '@/components/evolution/TableSkeleton';
import { EmptyState } from '@/components/evolution/EmptyState';
import { ElapsedTime } from '@/components/evolution/ElapsedTime';
import { buildExplanationUrl, buildRunUrl } from '@/lib/utils/evolutionUrls';
      ...
      render: (run) => {
        ...
        return (
          <div className="flex flex-col items-end gap-0.5">
            <span className="text-[var(--text-muted)]">Iter {run.current_iteration}</span>
            {isActive && (
