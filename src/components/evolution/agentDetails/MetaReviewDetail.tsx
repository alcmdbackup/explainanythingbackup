...
import type { MetaReviewExecutionDetail } from '@/lib/evolution/types';
...
export function MetaReviewDetail({ detail }: { detail: MetaReviewExecutionDetail }): JSX.Element {
    ...
    <div className="space-y-3" data-testid="meta-review-detail">
      ...
      <DetailSection title="Analysis Snapshot">
        <div className="grid grid-cols-3 sm:grid-cols-6 gap-3">
          ...
          <Metric label="Pool Diversity" value={analysis.poolDiversity.toFixed(2)} />
          <Metric label="Ordinal Range" value={analysis.ordinalRange.toFixed(0)} />
