...
- For debugging, always look at server.log and client.log on local path
- For debugging, also use playwright mcp server. If need to log in, use abecha@gmail.com as username, password as password
