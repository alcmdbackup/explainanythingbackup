...
- Staging environment: Dev database credentials + test users
...
- [x] Updated `ci.yml` - added `environment: staging` to integration-tests, e2e-critical, e2e-full jobs
- [x] Updated `e2e-nightly.yml` - added `environment: staging` to e2e-full job
