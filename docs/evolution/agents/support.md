...
| File | Purpose |
|------|---------|
| `src/lib/evolution/agents/reflectionAgent.ts` | Agent implementation with parallel critiques |
...
| File | Purpose |
|------|---------|
| `src/lib/evolution/agents/debateAgent.ts` | 4-call debate flow with JSON verdict parsing |
...
| File | Purpose |
|------|---------|
| `src/lib/evolution/agents/evolvePool.ts` | Genetic evolution with mutation, crossover, creative exploration, outline mutation |
...
| File | Purpose |
|------|---------|
| `src/lib/evolution/agents/proximityAgent.ts` | Sparse similarity matrix, diversity score computation, embedding cache |
...
| File | Purpose |
|------|---------|
| `src/lib/evolution/agents/metaReviewAgent.ts` | Strategy analysis, weakness detection, priority rules |
