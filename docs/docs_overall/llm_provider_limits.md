...
| OpenRouter | [openrouter.ai/activity](https://openrouter.ai/activity) | openai/gpt-oss-20b, google/gemini-2.5-flash (nightly real-AI smoke; `supportsJsonSchema` → schema-enforced structured output), google/gemini-2.5-flash-lite |
