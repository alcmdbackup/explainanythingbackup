...
**Evolution System:** All evolution pipeline docs are in [evolution/docs/](../../evolution/docs/README.md) — V2 pipeline architecture, operations, rating, cost optimization, and experiments (13 docs).
