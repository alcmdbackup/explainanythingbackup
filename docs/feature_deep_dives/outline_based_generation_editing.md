...
### Article Bank Metadata

When an outline variant wins, bank entries include:
```json
{
  "outline_mode": true,
  "outline": "## Section 1\nSummary...",
...
- [Comparison Infrastructure](./comparison_infrastructure.md) — Article bank outline methods
