...
| `scripts/run-hall-of-fame-comparison.ts` | CLI for running pairwise comparisons with multi-provider judge support |
| `scripts/add-to-hall-of-fame.ts` | Add existing evolution run winner to Hall of Fame |
