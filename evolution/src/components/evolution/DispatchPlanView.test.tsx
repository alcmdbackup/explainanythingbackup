...
function makeEntry(patch: Partial<IterationPlanEntryClient> = {}): IterationPlanEntryClient {
  ...
  return {
    ...
    estPerAgent: {
      expected: { gen: 0.0012, rank: 0.003, reflection: 0, editing: 0, editingRank: 0, evaluation: 0, debate: 0, total: 0.0042 },
      upperBound: { gen: 0.0017, rank: 0.006, reflection: 0, editing: 0, editingRank: 0, evaluation: 0, debate: 0, total: 0.0077 },
    },
...
describe('DispatchPlanView', () => {
      ...
      <DispatchPlanView
        plan={[
          ...
          makeEntry({
            ...
            dispatchCount: 0,
            estPerAgent: { expected: { gen: 0, rank: 0, reflection: 0, editing: 0, editingRank: 0, evaluation: 0, debate: 0, total: 0 }, upperBound: { gen: 0, rank: 0, reflection: 0, editing: 0, editingRank: 0, evaluation: 0, debate: 0, total: 0 } },
          }),
        ]}
        variant="wizard"
      />,
  ...
  it('shows delta + realization ratio when actual is supplied', () => {
    render(
      <DispatchPlanView
        plan={[makeEntry({ iterIdx: 0, dispatchCount: 3, estPerAgent: { expected: { gen: 0.001, rank: 0.003, reflection: 0, editing: 0, editingRank: 0, evaluation: 0, debate: 0, total: 0.004 }, upperBound: { gen: 0.001, rank: 0.003, reflection: 0, editing: 0, editingRank: 0, evaluation: 0, debate: 0, total: 0.004 } } })]}
  ...
  it('surfaces ranking-dominance warning when rank ≥ 70% of total', () => {
    ...
    render(
      <DispatchPlanView
        plan={[makeEntry({ estPerAgent: { expected: { gen: 0.0007, rank: 0.005, reflection: 0, editing: 0, editingRank: 0, evaluation: 0, debate: 0, total: 0.0057 }, upperBound: { gen: 0.001, rank: 0.010, reflection: 0, editing: 0, editingRank: 0, evaluation: 0, debate: 0, total: 0.011 } } })]}
        variant="wizard"
      />,
    );
      ...
      render(
        <DispatchPlanView
          plan={[makeEntry({
            ...
            estPerAgent: {
              expected: { gen: 0.001, rank: 0, reflection: 0, editing: 0, editingRank: 0, evaluation: 0, debate: 0, total: 0.001 },
              upperBound: { gen: 0.002, rank: 0, reflection: 0, editing: 0, editingRank: 0, evaluation: 0, debate: 0, total: 0.002 },
            },
          })]}
          variant="wizard"
        />,
