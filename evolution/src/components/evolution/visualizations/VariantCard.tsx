// Compact card displaying variant summary info (ID, Elo, tactic, iteration).
...
export function VariantCard({
  ...
  return (
    <div
      ...
      style={{ borderLeftColor: TACTIC_PALETTE[tactic] ?? 'var(--border-default)' }}
