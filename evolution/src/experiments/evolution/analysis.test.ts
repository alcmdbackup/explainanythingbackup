...
describe('computeManualAnalysis', () => {
  ...
  it('computes Elo and Elo/$ for completed runs', () => {
    const dbRuns = [
      { id: 'r1', status: 'completed', total_cost_usd: 0.50, run_summary: { topElo: 1200 }, config: { generationModel: 'gpt-4.1-mini', judgeModel: 'gpt-4.1-nano' } },
  ...
  it('warns about incomplete runs', () => {
    const dbRuns = [
      { id: 'r1', status: 'completed', total_cost_usd: 0.50, run_summary: { topElo: 1200 }, config: null },
