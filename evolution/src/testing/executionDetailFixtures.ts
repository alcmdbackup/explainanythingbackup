...
export const iterativeEditingDetailFixture: IterativeEditingExecutionDetail = {
  ...
  surfaced: true,
  // Phase 1.4 — realistic post-cycle ranking block. 2 comparisons against
  // a small in-run pool. Final elo above the top-15% cutoff so surfaced=true.
  ranking: {
    variantId: 'ie-final-001',
    localPoolSize: 8,
    localPoolVariantIds: [
      'ie-pool-a', 'ie-pool-b', 'ie-pool-c', 'ie-pool-d',
      'ie-pool-e', 'ie-pool-f', 'ie-pool-g', 'ie-final-001',
    ],
    initialTop15Cutoff: 1213,
    comparisons: [
      {
        round: 1,
        opponentId: 'ie-pool-a',
        selectionScore: 0.74,
        pWin: 0.51,
        variantEloBefore: 1200,
        variantUncertaintyBefore: 128,
        opponentEloBefore: 1195,
        opponentUncertaintyBefore: 140,
        outcome: 'win',
        confidence: 0.82,
        variantEloAfter: 1209,
        variantUncertaintyAfter: 96,
        opponentEloAfter: 1186,
        opponentUncertaintyAfter: 152,
        top15CutoffAfter: 1211,
        eloPlusTwoUncertainty: 1401,
        eliminated: false,
        converged: false,
        durationMs: 612,
      },
      {
        round: 2,
        opponentId: 'ie-pool-b',
        selectionScore: 0.68,
        pWin: 0.55,
        variantEloBefore: 1209,
        variantUncertaintyBefore: 96,
        opponentEloBefore: 1218,
        opponentUncertaintyBefore: 70,
        outcome: 'win',
        confidence: 0.74,
        variantEloAfter: 1215,
        variantUncertaintyAfter: 78,
        opponentEloAfter: 1212,
        opponentUncertaintyAfter: 75,
        top15CutoffAfter: 1213,
        eloPlusTwoUncertainty: 1371,
        eliminated: false,
        converged: true,
        durationMs: 587,
      },
    ...
    totalComparisons: 2,
    finalLocalElo: 1215,
    finalLocalUncertainty: 78,
    finalLocalTop15Cutoff: 1213,
    durationMs: 1245,
    cost: 0.0042,
  },
  totalCost: 0.0308,
