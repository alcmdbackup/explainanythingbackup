...
const MIGRATION_FILES = [
  ...
  'supabase/migrations/20260527000004_evolution_cost_calibration_paragraph_recombine_phase.sql',
  'supabase/migrations/20260630000001_evolution_cost_calibration_self_critique_phase.sql',
];
