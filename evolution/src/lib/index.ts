...
export { createRating, updateRating, updateDraw, isConverged, eloToRating, toEloScale, ordinalToEloScale, DEFAULT_MU, DEFAULT_SIGMA, DEFAULT_CONVERGENCE_SIGMA } from './core/rating';
