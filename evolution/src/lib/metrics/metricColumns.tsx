...
import { getEntityListViewMetrics } from '../shared/entityRegistry';
import { METRIC_FORMATTERS } from '../shared/metricCatalog';
import type { MetricFormatter } from '../shared/types';
...
export function createMetricColumns<T>(
  ...
  return getEntityListViewMetrics(entityType as import('../shared/types').EntityType).map(def => ({
