...
diff --cc evolution/docs/evolution/visualization.md
index 4f75930f,4f75930f,00000000..f8fbacc4
mode 100644,100644,000000..100644
--- a/evolution/docs/evolution/visualization.md
+++ b/evolution/docs/evolution/visualization.md
@@@@ -1,187 -1,187 -1,0 +1,187 @@@@
...
+++Built with Recharts for standard charts and D3.js for the variant lineage DAG. Rating data uses OpenSkill ordinal values (mu - 3*sigma), mapped to the 0-3000 Elo scale for display via `ordinalToEloScale()`. All views — Explorer table, matrix, trend, and per-agent metrics — use this consistent Elo-scale rating.
  +
  +## Pages
  +
  +| Route | Purpose |
