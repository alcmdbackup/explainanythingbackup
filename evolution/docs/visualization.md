...
| `/admin/evolution/tactics` | Tactic registry list showing all 24 tactics with per-tactic performance stats. Accessible via sidebar nav (after Strategies). | Tactic name, category, variant count, avg Elo |
