...
| `seedSelfCritiquePerfExperiment_20260630.ts` | SelfCritiquePerf 1-arm append to sister `bc10c2e0` — adds `self_critique_revise` (~10 runs) as 10th arm to the isolated Federal Reserve ELOEXP arena | [`analyze_performance_self_critique_agent_20260630`](../../../docs/planning/analyze_performance_self_critique_agent_20260630/) | 2026-07-01 |
